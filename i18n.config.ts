export default defineI18nConfig(() => ({
    ...
    messages: {
        ...
        ar: {
            ...
            paragraph: "منحة IESCO في ماليزيا (ISM) هي مبادرة من المنظمة الدولية للتعليم العلمي والثقافي (IESCO) لجذب الطلاب من الأماكن الأقل حظًا لمتابعة الدراسات الأكاديمية المتقدمة في ماليزيا. الطلاب الدوليون مرحب بهم للتقدم لهذه المنحة ومتابعة دراساتهم في الجامعات الماليزية المختارة.",
